...
export function CustomizeOrder() {
  ...
  return (
    <section className="py-14 sm:py-20 md:py-24 bg-forest relative overflow-hidden border-y border-gold/10">
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 md:mb-20">
          <span className="inline-block text-[9px] sm:text-[10px] font-heading font-bold uppercase tracking-widest text-gold border border-gold/30 bg-gold/5 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full mb-4 sm:mb-6">
          ...
          <p className="font-body text-cream/70 text-sm sm:text-base md:text-lg leading-relaxed px-2">
          ...
          {steps.map((step, i) => (
            <div key={i} className="flex flex-col items-center text-center relative">
              <div className="relative mb-6 sm:mb-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-gold/40 bg-forest-deep flex items-center justify-center text-gold shadow-[0_0_20px_rgba(201,151,58,0.1)]">
                  <step.icon className="w-7 h-7 sm:w-9 sm:h-9" />
                </div>
                <span className="absolute -top-2 -right-2 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gold text-forest-deep text-[9px] sm:text-[10px] font-heading font-bold flex items-center justify-center border-2 border-forest-deep">
                  {step.n}
                </span>
              </div>
              <h3 className="font-display text-xl sm:text-2xl text-gold mb-3 sm:mb-4">{step.title}</h3>
              <p className="font-body text-cream/60 text-xs sm:text-sm leading-relaxed max-w-xs">{step.desc}</p>
            </div>
          ))}
        </div>

        <div className="bg-forest-deep border border-gold/30 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 relative z-10">
            <div className="p-6 sm:p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-gold/15">
              ...
              <p className="font-body text-cream/50 text-xs sm:text-sm mb-6 sm:mb-8">Select the life area you most want to strengthen:</p>
            ...
            <div className="p-6 sm:p-8 md:p-12 flex flex-col">
              ...
              <p className="font-body text-cream/50 text-xs sm:text-sm mb-6 sm:mb-8">Fill in a few details and our Vedic expert will contact you within 24 hours.</p>
              ...
              {submitted ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-body text-cream/60 text-xs sm:text-sm leading-relaxed max-w-xs mx-auto">
                ...
                <form className="flex flex-col gap-4 sm:gap-5 flex-1" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" required placeholder="Your name" className="w-full bg-forest border border-gold/20 rounded-lg px-4 py-3 text-xs sm:text-sm font-body text-cream placeholder:text-cream/30 focus:outline-none focus:border-gold transition-colors" />
                    </div>
                    <div>
                      ...
                      <input type="tel" placeholder="+91 ..." className="w-full bg-forest border border-gold/20 rounded-lg px-4 py-3 text-xs sm:text-sm font-body text-cream placeholder:text-cream/30 focus:outline-none focus:border-gold transition-colors" />
                    </div>
                  </div>
                  <div>
                    <label className="text-[9px] sm:text-[10px] font-heading uppercase tracking-widest text-gold/60 block mb-2">Date of Birth</label>
                    <input type="date" className="w-full bg-forest border border-gold/20 rounded-lg px-4 py-3 text-xs sm:text-sm font-body text-cream/80 focus:outline-none focus:border-gold transition-colors" />
                  </div>
                  <div>
                    ...
                    <textarea rows={3} placeholder="Describe what you're seeking in more detail (optional)…" className="w-full bg-forest border border-gold/20 rounded-lg px-4 py-3 text-xs sm:text-sm font-body text-cream placeholder:text-cream/30 focus:outline-none focus:border-gold transition-colors resize-none" />
                  </div>
                  <button type="submit" className="mt-auto w-full py-3.5 sm:py-4 bg-gradient-to-r from-gold to-gold-soft text-forest-deep font-heading font-bold uppercase tracking-widest text-xs sm:text-sm rounded-xl hover:shadow-[0_0_25px_rgba(201,151,58,0.4)] transition-all flex items-center justify-center gap-2">
