...
export function TrustStrip() {
  return (
    <section className="relative py-14 sm:py-20 md:py-24 border-y border-gold/20 bg-[#0A1A14]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {trustItems.map((item, i) => (
            <div 
              key={i} 
              className="relative p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border border-gold/10 bg-[#0F261E]/60 backdrop-blur-md flex flex-col items-center text-center group hover:bg-[#0F261E] hover:border-gold/30 transition-all duration-500"
            >
              ...
              <div className="relative mb-4 sm:mb-6">
                ...
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full border border-gold/30 bg-[#0A1A14] flex items-center justify-center text-gold shadow-lg group-hover:scale-105 transition-all duration-500">
