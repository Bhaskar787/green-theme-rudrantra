        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {collections.map((item, i) => (
            <a key={i} href="#" className="group flex flex-col gap-5">
              <div className="aspect-square rounded-xl overflow-hidden border border-gold/20 relative">
                <img 
                  src={item.image} 
                  alt={item.name} 
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 brightness-90 group-hover:brightness-100"
                />
                <div className="absolute inset-0 bg-forest-deep/40 group-hover:bg-transparent transition-colors duration-500"></div>
          ...
          <a href="#" className="group flex flex-col gap-5">
            <div className="aspect-square rounded-xl border border-gold/30 bg-forest-deep flex flex-col items-center justify-center gap-4 transition-all duration-500 group-hover:border-gold group-hover:shadow-sacred-glow">
              <div className="w-14 h-14 rounded-full border border-gold/40 flex items-center justify-center text-gold group-hover:bg-gold group-hover:text-forest transition-colors">
                <GiSpiralArrow className="w-6 h-6" />
              </div>
              <span className="font-display text-lg text-gold group-hover:text-gold-bright transition-colors">All Products</span>
            </div>
