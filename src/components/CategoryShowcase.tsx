export function CategoryShowcase() {
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-forest-deep relative">
      {/* OM Section Divider */}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="text-cream-soft font-body text-sm sm:text-base md:text-lg opacity-80 max-w-2xl mx-auto px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:auto-rows-[300px]">
          ...
          <a href="#" className="relative group md:row-span-2 overflow-hidden rounded-xl sm:rounded-2xl h-[220px] sm:h-[280px] md:h-auto block border border-gold/30">
            <img
          ...
          <a href="#" className="relative group overflow-hidden rounded-xl sm:rounded-2xl h-[180px] sm:h-[240px] md:h-auto block border border-gold/30">
            <img
          ...
          <a href="#" className="relative group md:row-span-2 overflow-hidden rounded-xl sm:rounded-2xl h-[220px] sm:h-[280px] md:h-auto block border border-gold/50 shadow-sacred-glow">
            <img
